...
- [Snippets instead of slots](#snippets-instead-of-slots)
    ...
    - [Passing data back up](#passing-data-back-up)
- [Migration script](#migration-script)
    - [run](#run)
    - [Event modifiers](#event-modifiers)
    - [Things that are not automigrated](#things-that-are-not-automigrated)
- [Components are no longer classes](#components-are-no-longer-classes)
    ...
    - [bind:this changes](#bindthis-changes)
- [`<svelte:component>` is no longer necessary](#sveltecomponent-is-no-longer-necessary)
